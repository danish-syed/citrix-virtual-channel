...
typedef int    (PWFCAPI PMIGETPRIVATEPROFILESTRING)     ( PCHAR, PCHAR, PCHAR,
                                                          PCHAR, int );
typedef int    (PWFCAPI PMIGETPRIVATEPROFILEINT)        ( LPCSTR, LPCSTR, int );
typedef LONG   (PWFCAPI PMIGETPRIVATEPROFILELONG)       ( LPCSTR, LPCSTR, LONG );
typedef BOOL   (PWFCAPI PMIGETPRIVATEPROFILEBOOL)       ( LPCSTR, LPCSTR, BOOL );

typedef int    (PWFCAPI PMISETPRIVATEPROFILESTRING)     ( PCCH, PCCH, PCCH );
...
typedef int    (PWFCAPI PMISERVERSECTIONNAMEW)          (LPWSTR, DWORD);
...
typedef struct _MEMINITABLE
{
    ...
    PMISERVERSECTIONNAMEW         pmiServerSectionNameW;
#endif
...
#define miGetPrivateProfileStringInUTF16   \
                        (*(g_pMemIniCallTable)->pmiGetPrivateProfileStringInUTF16)
#define miGetServerSectionNameW   \
                        (*(g_pMemIniCallTable)->pmiServerSectionNameW)
#endif
...
#endif
#endif
int    WFCAPI miGetPrivateProfileInt          (LPCSTR, LPCSTR, int);
LONG   WFCAPI miGetPrivateProfileLong         (LPCSTR, LPCSTR, LONG);
BOOL   WFCAPI miGetPrivateProfileBool         (LPCSTR, LPCSTR, BOOL);
...
int miLoadICAFile(LPCCH, LPCCH, LPCCH, LPCCH);
int miLoadICAFileEx(LPCCH, LPCCH, LPCCH, LPCCH);
int miServerSectionName( LPTSTR, DWORD );
#ifdef UNICODE
#define miServerSectionNameW miServerSectionName
#else /* UNICODE */
int WFCAPI miServerSectionNameW(LPWSTR, DWORD);
#endif /* UNICODE */
