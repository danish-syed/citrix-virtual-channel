/*
this is a file used for common errors that have to be unique
and/or should be shared by multiple projects
 */
#ifndef ICACLIENTWIN_ERRORCODES_H_
#define ICACLIENTWIN_ERRORCODES_H_
...
#define CLIENT_STATUS_BUFFER_RESIZE                 82   /* Client is resizing buffer and sending to server */
#define CLIENT_STATUS_GET_AADSSON_INFO				84
#define CLIENT_STATUS_SEND_PACKET_HDXDIRECT_C2H		85 // Send PACKET_HDXDIRECT_H2C
#define CLIENT_STATUS_HDX_DIRECT_CONNECT            86 /* Set HDX Direct Connection Details in WFCRUN */
#define CLIENT_STATUS_CONNECTION_STRENGTH_METRICS   87 // Client has sent connection status metrics
#define CLIENT_STATUS_VISUALLY_READY                88 /* Session is visually ready. */
#define CLIENT_STATUS_CONNECTION_STRENGTH_METRICS     87 // Client has sent connection status metrics
...
#define	CLIENT_ERROR_APP_PROTECTION_COMPONENT_MISSING 1124
#define CLIENT_ERROR_ANTIDLL_INJECTION_FAILED	      1125
#define CLIENT_ERROR_ANTIDLL_INJECTION_DETECTED	  1126

#define CLIENT_ERROR_INVALID_DATA                 1127
#define CLIENT_ERROR_SYSTEM_CALL_FAILED		      1128

#define CLIENT_ERROR_SERVER_NOT_TRUSTED           1129

#define CLIENT_ERROR_SHARED_MEM_OPEN_FAILED		  1130
#define CLIENT_ERROR_SHARED_MEM_MAP_FAILED		  1131
#define CLIENT_ERROR_PROCESS_INIT_FAILED		  1132

#define CLIENT_ERROR_APP_PROTECTION_ASC_FAILED	  1147
#define CLIENT_ERROR_APP_PROTECTION_AKL_FAILED	  1148
#define CLIENT_ERROR_APP_PROTECTION_FAILED		  1149

#define CLIENT_ERROR_BAD_ICA_PACKET				  1150	// skipping numbers in case other errors were added.

#define CLIENT_ERROR_UNKNOWN                      1199
...
#define	CLIENT_ERROR_PROXYCOMMON_NOT_CONFIGURED           (CLIENT_ERROR_PROXY_OFFSET+31)
#define	CLIENT_ERROR_PROXYCOMMON_FAILED_TO_LOAD           (CLIENT_ERROR_PROXY_OFFSET+32)

#define CLIENT_ERROR_PROXY_ERROR__LAST        (CLIENT_ERROR_PROXY_OFFSET+32)
...
//App Protection virtual channel error codes
//Range of 4000-4050 is reserved for App protection virtual channel specific errors

#define CLIENT_ERROR_APPPROTECTION_DISCONNECT 4000
#define CLIENT_ERROR_APPP_DISCONNECT_POLICY_MISMATCH 4001
#define CLIENT_ERROR_APPP_DISCONNECT_UNSUPPORTED_CLIENT 4002
#define CLIENT_ERROR_APPP_DISCONNECT_INSUFFICIENT_CAPABILITIES 4003

#define ERROR_DEFAULT   0xffff								// default error used in various resource files (*.rc)


// Gateway error codes
#define	CLIENT_ERROR_GATEWAY_OFFSET			     2500

#define	CLIENT_ERROR_GATEWAY_STA_INVALID_TKT        (CLIENT_ERROR_GATEWAY_OFFSET+17)
#define CLIENT_ERROR_GATEWAY_STA_NO_RECONNECT_TKT   (CLIENT_ERROR_GATEWAY_OFFSET+18)
#define	CLIENT_ERROR_GATEWAY_STA_LOOKUP_FAILED 	    (CLIENT_ERROR_GATEWAY_OFFSET+19)
#define CLIENT_ERROR_GATEWAY_STA_WRONG_TKT_FORMAT   (CLIENT_ERROR_GATEWAY_OFFSET+20)
#define CLIENT_ERROR_GATEWAY_BIND_REQ_PARSE_FAILURE (CLIENT_ERROR_GATEWAY_OFFSET+21)
#define CLIENT_ERROR_GATEWAY_NO_LICENSE				(CLIENT_ERROR_GATEWAY_OFFSET+22)
#define CLIENT_ERROR_GATEWAY_VDA_DNS_FAILURE		(CLIENT_ERROR_GATEWAY_OFFSET+23)
#define CLIENT_ERROR_GATEWAY_VDA_CONNECTION_REFUSED (CLIENT_ERROR_GATEWAY_OFFSET+24)
#define CLIENT_ERROR_GATEWAY_SERVER_FAILURE			(CLIENT_ERROR_GATEWAY_OFFSET+25)

#define	CLIENT_ERROR_GATEWAY_LAST_ERROR			 2600

// errors picked from CGP_API.c
#define CLIENT_ERROR_CGP_OFFSET                  2700
#define CLIENT_ERROR_CGP_INVALID_PARAMETER       (CLIENT_ERROR_CGP_OFFSET+1)
#define CLIENT_ERROR_CGP_VERSION_MISMATCH        (CLIENT_ERROR_CGP_OFFSET+2)
#define CLIENT_ERROR_CGP_INVALID_CALL            (CLIENT_ERROR_CGP_OFFSET+3)
#define CLIENT_ERROR_CGP_DUPLICATE_SERVICE_NAME  (CLIENT_ERROR_CGP_OFFSET+4)
#define CLIENT_ERROR_CGP_INVALID_SERVICE         (CLIENT_ERROR_CGP_OFFSET+5)
#define CLIENT_ERROR_CGP_NOT_IMPLEMENTED         (CLIENT_ERROR_CGP_OFFSET+6)
#define CLIENT_ERROR_CGP_INVALID_SERVICE_HANDLE  (CLIENT_ERROR_CGP_OFFSET+7)
#define CLIENT_ERROR_CGP_NOT_CGP                 (CLIENT_ERROR_CGP_OFFSET+8)
#define CLIENT_ERROR_CGP_SERVICE_ALREADY_LOADED  (CLIENT_ERROR_CGP_OFFSET+9)
#define CLIENT_ERROR_CGP_SERVICE_NOT_BOUND       (CLIENT_ERROR_CGP_OFFSET+10)
#define CLIENT_ERROR_CGP_ILLEGAL_REENTRENCY      (CLIENT_ERROR_CGP_OFFSET+11)
#define CLIENT_ERROR_CGP_MEMORY                  (CLIENT_ERROR_CGP_OFFSET+12)
#define CLIENT_ERROR_CGP_INVALID_MESSAGE         (CLIENT_ERROR_CGP_OFFSET+13)
#define CLIENT_ERROR_CGP_LOG_FILE                (CLIENT_ERROR_CGP_OFFSET+14)
#define CLIENT_ERROR_CGP_NO_FREE_CHANNELS        (CLIENT_ERROR_CGP_OFFSET+15)
#define CLIENT_ERROR_CGP_VDA_BLOCKED             (CLIENT_ERROR_CGP_OFFSET+16)
// Not an actual CGP error. It corresponds to CGP_STAT_RECON_FAILED.
#define CLIENT_ERROR_CGP_RECONNECT_FAILED        2798
#define CLIENT_ERROR_CGP_LAST_ERROR              2799

//errors picked from udtc.h
#define CLIENT_ERROR_UDT_OFFSET                  2800
#define CLIENT_ERROR_UDT_CONNECTION_CLOSED       (CLIENT_ERROR_UDT_OFFSET + 1)
#define CLIENT_ERROR_UDT_NO_SERVER               (CLIENT_ERROR_UDT_OFFSET + 2)
#define CLIENT_ERROR_UDT_CONNECTION_REJECTED     (CLIENT_ERROR_UDT_OFFSET + 3)
#define CLIENT_ERROR_UDT_FAILED_SECURITY_CHECK   (CLIENT_ERROR_UDT_OFFSET + 5)
#define CLIENT_ERROR_UDT_NO_MEMORY               (CLIENT_ERROR_UDT_OFFSET + 11)
#define CLIENT_ERROR_UDT_INVALID_OPERATION       (CLIENT_ERROR_UDT_OFFSET + 17)
#define CLIENT_ERROR_UDT_NO_CONNECTION           (CLIENT_ERROR_UDT_OFFSET + 19)
#define CLIENT_ERROR_UDT__LAST             2899
...
*
* Remarks: If your error is not listed here, then wfica might return a CLIENT_ERROR_PD_ERROR rather than the more detailed error
*
***********************************************************************/
__inline BOOL IsDetailedError(INT iErrorCode)
{
    BOOL ret = FALSE;
    if ((CLIENT_ERROR_PD_ERROR == iErrorCode) || (iErrorCode == CLIENT_ERROR_SERVER_NOT_TRUSTED) || (iErrorCode >= WSABASEERR && iErrorCode <= ID_WSAERR__LAST) ||
        ...
        (iErrorCode >= CLIENT_ERROR_GATEWAY_OFFSET && iErrorCode <= CLIENT_ERROR_GATEWAY_LAST_ERROR) ||
        (iErrorCode >= CLIENT_ERROR_CGP_OFFSET && iErrorCode <= CLIENT_ERROR_CGP_LAST_ERROR) ||
        (iErrorCode >= CLIENT_ERROR_PROXY_OFFSET && iErrorCode <= CLIENT_ERROR_PROXY_ERROR__LAST) ||
        (iErrorCode >= CLIENT_ERROR_UDT_OFFSET && iErrorCode <= CLIENT_ERROR_UDT__LAST) ||
        (iErrorCode != CLIENT_ERROR_SSLSDK_SUCCESS && iErrorCode != CLIENT_ERROR_SSLSDK_RENEGOTIATE &&
            iErrorCode != CLIENT_ERROR_SSLSDK_HANDSHAKE_COMPLETE && (iErrorCode >= CLIENT_ERROR && iErrorCode <= CLIENT_ERROR__LAST))
        )
    {
        ret = TRUE;
    }
